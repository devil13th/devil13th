...
function loadTaskDgByTrace(id) {
	taskTable.datagrid("load", {PROJECT_ID:"${seRequirementTrace.projectId}",TRACE_ID:id});
}
//重置待办表单后查询
...
<body class="easyui-layout">
	<div data-options="region:'west',split:true,title:'矩阵树'" style="width:350px;" >
	...
	<div data-options="region:'south',split:false" style="padding:2px;height:30px;text-align:center;" >
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-right1'" onclick="getSelectedData()">确定</a> 
	</div>
	
	<div id="win" title="任务信息"><iframe id="winSrc" frameborder="0" width="100%" height="100%"></iframe></div>
</body>
</html>
