...
<div class="navbar-fixed-bottom" style="padding:10px;background:#eee;">
	<div class="row">
		...
		<div class="col-sm-6 text-right">
			...
			<button class="btn btn-primary" type="button" onclick="setProcVar(1);return theFormSubmit('next')">关闭流程</button>
			<button class="btn btn-primary" type="button" onclick="setProcVar(0);return theFormSubmit('next')">审核不通过</button>
