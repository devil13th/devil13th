...
<div class="portlet portlet-sortable box grey-mint" data-step="9" data-intro="项目会议">
	<div class="portlet-title">
		<div class="caption">
			<i class="glyphicon glyphicon-list-alt"></i> Risk </div>
		<div class="actions">
			<a href="javascript:;" class="btn btn-default btn-sm" onclick="showWin('${ctx}/se/se!seRiskList.do')">
					<i class="glyphicon glyphicon-th-list" ></i> More List
			</a>
			<a href="javascript:;" class="btn btn-default btn-sm" onclick="newRisk()">
	...
	<div class="portlet-body portlet-body-self">
			...
			<div>
			    <div class="input-group">
			      <input type="text" class="form-control" id="pluginRiskQueryKey" placeholder="Search for...">
			      <span class="input-group-btn">
			        <button class="btn btn-default" type="button" onclick="reloadRiskTab()"> <i class="glyphicon glyphicon-search"></i> Search</button>
			      </span>
			    </div><!-- /input-group -->
			</div>
...
function newRisk(){
	openLayer("项目会议","${ctx}/se/se!seRiskForm.do?seRisk.projectId=${projectId}");
}

//刷新
function reloadRiskTab(){
		...
		*/
		riskTab.ajax.reload(null,false);
}
</script>