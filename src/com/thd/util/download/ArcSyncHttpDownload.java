...
public class ArcSyncHttpDownload {
	 private static final long serialVersionUID = 1L;  
	    final static Log log = LogFactory.getLog(ArcSyncHttpDownload.class);  

	 public static void download(String filePath,String realName, HttpServletRequest request, HttpServletResponse response){
